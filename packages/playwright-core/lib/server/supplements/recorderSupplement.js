...
class RecorderSupplement {
  ...
  async install(showRecorder) {
    if (showRecorder) await this.installRecorder();
    ...
    this._context.once(_browserContext.BrowserContext.Events.Close, () => {
      ...
      (_this$_recorderApp = this._recorderApp) === null || _this$_recorderApp === void 0 ? void 0 : _this$_recorderApp.close().catch(() => {});
    });
    ...
    this._contextRecorder.on(ContextRecorder.Events.Change, data => {
      ...
      (_this$_recorderApp2 = this._recorderApp) === null || _this$_recorderApp2 === void 0 ? void 0 : _this$_recorderApp2.setFile(data.primaryFileName);
    });
    ...
    await this._context.exposeBinding('_playwrightRecorderSetSelector', false, async (_, selector) => {
      var _this$_recorderApp3, _this$_recorderApp4;

      this._setMode('none');

      this._contextRecorder.emitSelector(selector);

      await ((_this$_recorderApp3 = this._recorderApp) === null || _this$_recorderApp3 === void 0 ? void 0 : _this$_recorderApp3.setSelector(selector, true));
      await ((_this$_recorderApp4 = this._recorderApp) === null || _this$_recorderApp4 === void 0 ? void 0 : _this$_recorderApp4.bringToFront());
    }); // added for synthetics

    await this._context.exposeBinding('_playwrightSetMode', false, async (_, mode) => {
      this._setMode(mode);
    });
  ...
  _pausedStateChanged() {
    ...
    (_this$_recorderApp5 = this._recorderApp) === null || _this$_recorderApp5 === void 0 ? void 0 : _this$_recorderApp5.setPaused(this._debugger.isPaused());
  ...
  _setMode(mode) {
    ...
    this._mode = mode;
    (_this$_recorderApp6 = this._recorderApp) === null || _this$_recorderApp6 === void 0 ? void 0 : _this$_recorderApp6.setMode(this._mode);
  ...
  async onBeforeCall(sdkObject, metadata) {
    ...
    if (metadata.params && metadata.params.selector) {
      ...
      (_this$_recorderApp7 = this._recorderApp) === null || _this$_recorderApp7 === void 0 ? void 0 : _this$_recorderApp7.setSelector(this._highlightedSelector).catch(() => {});
    }
  }
  ...
  _updateUserSources() {
    ...
    if (fileToSelect) (_this$_recorderApp8 = this._recorderApp) === null || _this$_recorderApp8 === void 0 ? void 0 : _this$_recorderApp8.setFile(fileToSelect);
  }

  _pushAllSources() {
    var _this$_recorderApp9;

    (_this$_recorderApp9 = this._recorderApp) === null || _this$_recorderApp9 === void 0 ? void 0 : _this$_recorderApp9.setSources([...this._recorderSources, ...this._userSources.values()]);
  }
  ...
  updateCallLog(metadatas) {
    ...
    (_this$_recorderApp10 = this._recorderApp) === null || _this$_recorderApp10 === void 0 ? void 0 : _this$_recorderApp10.updateCallLogs(logs);
  }
...
class ContextRecorder extends _events.EventEmitter {
  constructor(context, params) {
    ...
    this._recorderSources = [];
    const generator = new _codeGenerator.CodeGenerator(context._browser.options.name, !!params.startRecording, params.launchOptions || {}, params.contextOptions || {}, params.device, params.saveStorage, params.actionListener);
  ...
  emitSelector(selector) {
    var _this$_params$actionL;

    (_this$_params$actionL = this._params.actionListener) === null || _this$_params$actionL === void 0 ? void 0 : _this$_params$actionL.emit('selector', selector);
  }
  ...
  async _describeFrame(frame) {
    ...
    const result = await (0, _async.raceAgainstTimeout)(() => Promise.all(selectorPromises), 2000);
