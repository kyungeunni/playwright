...
class Recorder {
  constructor(injectedScript) {
    ...
    this._highlight = new _highlight.Highlight(injectedScript.isUnderTest);
  ...
  _onFocus() {
    ...
    const result = activeElement ? (0, _selectorGenerator.generateSelector)(this._injectedScript, activeElement, true) : null;
  ...
  _updateModelForHoveredElement() {
    ...
    const {
      selector,
      elements
    } = (0, _selectorGenerator.generateSelector)(this._injectedScript, hoveredElement, true);
