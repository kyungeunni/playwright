...
class CodeGenerator extends _events.EventEmitter {
  constructor(browserName, generateHeaders, launchOptions, contextOptions, deviceName, saveStorage, actionListener) {
  ...
  didPerformAction(actionInContext) {
    ...
    this.emit('change');
    (_this$_options$action = this._options.actionListener) === null || _this$_options$action === void 0 ? void 0 : _this$_options$action.emit('actions', this._actions);
  }
  ...
  signal(pageAlias, frame, signal) {
    ...
    if (this._lastAction && !this._lastAction.committed) {
      ...
      this.emit('change');
      (_this$_options$action2 = this._options.actionListener) === null || _this$_options$action2 === void 0 ? void 0 : _this$_options$action2.emit('actions', this._actions);
      return;
    }
