...
class ContextRecorder extends _events.EventEmitter {
  constructor(context, params) {
    ...
    const generator = new _codeGenerator.CodeGenerator(context._browser.options.name, params.mode === 'recording', params.launchOptions || {}, params.contextOptions || {}, params.device, params.saveStorage, params.actionListener);
    generator.on('change', () => {
      this._recorderSources = [];
